function similarityForce()
{
    ...
    function chart(selection) {
        selection.each(function (data) {
            ...
            $("#"+ panelID + " .panel-body")
                .append('Select the value of %: <input id= "slider-similarity-' + panelID+  '" type="text" data-slider-min="55" data-slider-max="100" data-slider-step="5" data-slider-value="75"/>');
