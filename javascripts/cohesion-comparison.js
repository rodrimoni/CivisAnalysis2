            ...
            container.append("xhtml:div")
                ...
                .on("click", function () {
                    ...
                    openGroupEditor({
                        ...
                        title: isEnglish ? "Add New Group" : "Adicionar Novo Grupo",
                        confirmLabel: isEnglish ? "Add to Chart" : "Adicionar ao Grafico",
                        initialColor: SERIES_PALETTE[getNextAvailablePaletteIndex()].color,
                        nextColor: function () { return SERIES_PALETTE[getNextAvailablePaletteIndex()].color; },
                        onSave: function (editorState) { addSeriesFromEditor(editorState); }
                    });
                });
        }
