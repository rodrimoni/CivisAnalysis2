    ...
    function buildPartyChips(container, editorState) {
        ...
        partiesList.forEach(function (party) {
            ...
            chipsContainer.append("xhtml:span")
                ...
                .style("cursor", "pointer")
                .style("background", isSelected ? hexToRgba(partyColor, 0.2) : "#f8fafc")
    ...
    function buildMembersSection(container, editorState) {
        ...
        editorState.selectedParties.forEach(function (party) {
            ...
            chipsDiv.append("xhtml:span")
                ...
                .style("background", hexToRgba(partyColor, 0.15))
        ...
        editorState.selectedDeputies.forEach(function (dep, i) {
            ...
            chipsDiv.append("xhtml:span")
                ...
                .style("border-radius", "12px")
                .style("font-size", "10px")
                .style("background", hexToRgba(partyColor, 0.1))
                .style("border", "1px solid " + hexToRgba(partyColor, 0.3))
                .style("color", "#374151")
                .html(dep.name + ' <span style="cursor:pointer;color:#ef4444;font-weight:bold;margin-left:2px;" class="remove-deputy">&times;</span>')
                .on("click", function () {
