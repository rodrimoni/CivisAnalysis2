var CONGRESS_DEFINE = {
    ...
    getConstantPartyColor: function (party) {
        if (CONGRESS_DEFINE.partiesColors[party] !== undefined) { return CONGRESS_DEFINE.partiesColors[party]; }
...
CONGRESS_DEFINE.timelineCropExtent = { "1991": [-0.7502, 0.2766], "1992": [-0.5739, 0.3348], "1993": [-0.7189, 0.6815], "1994": [-0.6745, 0.3783], "1995": [-0.8266, 0.103], "1996": [-0.8458, 0.1027], "1997": [-0.9633, 0.09928], "1998": [-0.7644, 0.1567], "1999": [-1.048, 0.1293], "2000": [-1.153, 0.3573], "2001": [-0.981, 0.2493], "2002": [-0.8191, 0.4574], "2003": [-0.9816, 0.2288], "2004": [-0.8146, 0.4025], "2005": [-0.8002, 0.5066], "2006": [-0.8037, 0.5122], "2007": [-1.06, 0.1498], "2008": [-0.9673, 0.3039], "2009": [-0.9931, 0.333], "2010": [-0.7985, 0.4744], "2011": [-0.9054, 0.325], "2012": [-0.7321, 0.6279], "2013": [-0.8085, 0.8051], "2014": [-0.5638, 0.7591], "2015": [-1.166, 0.7621], "2016": [-1.112, 0.4995], "2017": [-1.024, 0.2872], "2018": [-0.8794, 0.3432], "2019": [-1.184, 0.5722], "2020": [-0.7282, 0.3942], "2021": [-1.459, 0.44], "2022": [-1.375, 0.6517], "2023": [-1.022, 0.7582], "2024": [-1.139, 0.5491], "2025": [-1.122, 0.4537] }
...
CONGRESS_DEFINE.parties = {
    ...
    // merge with PTB and Patriota
    PRD: { name: 'Partido Renovaçâo Democrática', wing: 'right-wing', military: '', wiki: 'https://pt.wikipedia.org/wiki/Partido_Renova%C3%A7%C3%A3o_Democr%C3%A1tica' }
};
...
CONGRESS_DEFINE.subjectsToColor = {
    "Defesa e Segurança": "#1f77b4",  // Defense and Security
    "Administração Pública": "#ff7f0e",  // Public Administration
    "Relações Internacionais e Comércio Exterior": "#2ca02c",  // International Relations and Foreign Trade
    "Processo Legislativo e Atuação Parlamentar": "#d62728",  // Legislative Process and Parliamentary Activity
    "Economia": "#9467bd",  // Economy
    "Direito Penal e Processual Penal": "#8c564b",  // Criminal Law and Criminal Procedure
    "Finanças Públicas e Orçamento": "#e377c2",  // Public Finance and Budget
    "Política, Partidos e Eleições": "#7f7f7f",  // Politics, Parties, and Elections
    "Viação, Transporte e Mobilidade": "#bcbd22",  // Transportation and Mobility
    "Meio Ambiente e Desenvolvimento Sustentável": "#17becf",  // Environment and Sustainable Development
    "Direitos Humanos e Minorias": "#aec7e8",  // Human Rights and Minorities
    "Energia, Recursos Hídricos e Minerais": "#ffbb78",  // Energy, Water Resources, and Minerals
    "Previdência e Assistência Social": "#98df8a",  // Social Security and Welfare
    "Arte, Cultura e Religião": "#ff9896",  // Arts, Culture, and Religion
    "Direito Civil e Processual Civil": "#c5b0d5",  // Civil Law and Civil Procedure
    "Educação": "#c49c94",  // Education
    "Trabalho e Emprego": "#f7b6d2",  // Work and Employment
    "Saúde": "#c7c7c7",  // Health
    "Cidades e Desenvolvimento Urbano": "#dbdb8d",  // Cities and Urban Development
    "Esporte e Lazer": "#9edae5",  // Sports and Leisure
    "Comunicações": "#393b79",  // Communications
    "Agricultura, Pecuária, Pesca e Extrativismo": "#5254a3",  // Agriculture, Livestock, Fishing, and Extractivism
    "Homenagens e Datas Comemorativas": "#6b6ecf",  // Tributes and Commemorative Dates
    "Indústria, Comércio e Serviços": "#9c9ede",  // Industry, Trade, and Services
    "Ciência, Tecnologia e Inovação": "#637939",  // Science, Technology, and Innovation
    "Estrutura Fundiária": "#8ca252",  // Land Structure
    "Turismo": "#b5cf6b",  // Tourism
    "Direito e Defesa do Consumidor": "#cedb9c",  // Consumer Rights and Protection
    "Direito e Justiça": "#8c6d31",  // Law and Justice
    "Direito Constitucional": "#e6550d"  // Constitutional Law
}
